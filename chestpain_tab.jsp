...
%>
<h1>Frequency Table for Chest Pain data..</h1>
<font size="" color="#ec3333">

<table width="60%" cellspacing="10">
<tr><td><h3>Chest Pain Category<td><h3>Yes Score<td><h3>No Score
<% 
try{
	...
	String sss1 = "SELECT * FROM ChestPain_tab ";
...
<form method="post" action="cholesterol_tab.jsp">
	<input type="submit" value="For Cholesterol Data">
</form>
<br><br><br><br><br>
