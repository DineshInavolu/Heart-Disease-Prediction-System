...
%>
<h1>Frequency Table for Blood Sugar data..</h1>
<font size="" color="#ec3333">

<table width="60%" cellspacing="10">
<tr><td><h3>Blood Sugar Category<td><h3>Yes Score<td><h3>No Score
<% 
try{
	...
	String sss1 = "SELECT * FROM bs_tab ";
...
<form method="post" action="total.jsp">
	<input type="submit" value="For Total Data">
</form>
<br><br><br><br><br>
