...
%>
<h1>Frequency Table for Blood Pressure data..</h1>
<font size="" color="#ec3333">

<table width="60%" cellspacing="10">
<tr><td><h3>Blood Pressure Category<td><h3>Yes Score<td><h3>No Score
<% 
try{
	...
	String sss1 = "SELECT * FROM bp_tab ";
...
<form method="post" action="bloodsugar.jsp">
	<input type="submit" value="For Blood Sugar Data">
</form>
<br><br><br><br><br>
