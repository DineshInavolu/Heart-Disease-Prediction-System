...
%>
<h1>Frequency Table for Cholesterol data..</h1>
<font size="" color="#ec3333">

<table width="60%" cellspacing="10">
<tr><td><h3>Cholesterol Category<td><h3>Yes Score<td><h3>No Score
<% 
try{
	...
	String sss1 = "SELECT * FROM cholesterol_tab ";
...
<form method="post" action="bloodpressure_tab.jsp">
	<input type="submit" value="For Bloodpressure Data">
</form>
<br><br><br><br><br>
