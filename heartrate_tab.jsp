...
%>
<h1>Frequency Table for HeartRate data..</h1>
<font size="" color="#ec3333">

<table width="60%" cellspacing="10">
<tr><td><h3>HeartRate Category<td><h3>Yes Score<td><h3>No Score
<% 
try{
	...
	String sss1 = "SELECT * FROM `HeartRate_tab` ";
...
<form method="post" action="chestpain_tab.jsp">
	<input type="submit" value="For Chest Pain Data">
</form>
<br><br><br><br><br>
