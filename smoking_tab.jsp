...
%>
<h1>Frequency Table for Exercise data..</h1>
<font size="" color="#ec3333">

<table width="60%" cellspacing="10">
<tr><td><h3>Exercise Category<td><h3>Yes Score<td><h3>No Score
<% 
try{
	...
	String sss1 = "SELECT * FROM `smoker_tab` ";
...
<form method="post" action="heartrate_tab.jsp">
	<input type="submit" value="For HeartRate Data">
</form>
<br><br><br><br><br>
